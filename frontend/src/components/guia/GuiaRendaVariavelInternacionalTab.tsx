...
export default function GuiaRendaVariavelInternacionalTab({
  IndexChart,
  googleUrl,
  setSearchParams,
  RENDA_VARIAVEL_INTERNACIONAL_DETAILS
}: GuiaRendaVariavelInternacionalTabProps) {
  return (
    <div className="space-y-8">
      ...
      <div className="bg-card border border-border rounded-2xl p-6 shadow-xl">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-xl font-semibold text-foreground">Estratégias de Investimento Internacional</h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
